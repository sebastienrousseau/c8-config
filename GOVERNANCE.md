...
This document describes how @sebastienrousseau/c8-config is run: who decides what, how
...
@sebastienrousseau/c8-config is **maintainer-led**. As of the current release line it has a single
