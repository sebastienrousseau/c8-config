...
<p align="center">
  Shareable c8 code coverage configuration files and rules
</p>
...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@sebastienrousseau/c8-config"><img src="https://img.shields.io/npm/v/%40sebastienrousseau%2Fc8-config.svg?style=for-the-badge&color=fc8d62&logo=npm" alt="npm package" /></a>
  <a href="https://sebastienrousseau.com/c8-config/"><img src="https://img.shields.io/badge/docs-sebastienrousseau.com-brightgreen.svg?style=for-the-badge&logo=github" alt="Documentation" /></a>
  ...
  <a href="https://www.bestpractices.dev/projects/14506"><img src="https://img.shields.io/cii/level/14506?style=for-the-badge&label=OpenSSF%20Best%20Practices&logo=openssf" alt="OpenSSF Best Practices" /></a>
...
- [Code Coverage Thresholds](#code-coverage-thresholds) — before and after rule comparison
...
Install `@sebastienrousseau/c8-config` as a development dependency:
...
c8 reads `.c8rc.json`, or a JS config that requires this package.
...
`@sebastienrousseau/c8-config` is a focused satellite of the [`@sebastienrousseau/config`](https://github.com/sebastienrousseau/config) suite — a unified ecosystem of 21 single-purpose, zero-overhead developer configurations designed to share a single design philosophy, strict typing, and zero runtime dependencies.
...
`@sebastienrousseau/c8-config` solves this with three deliberate engineering choices:
...
When using non-V8 coverage instrumentation runners (such as legacy Istanbul babel-plugin transforms) requiring custom AST rewriting.
