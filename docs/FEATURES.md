# `@sebastienrousseau/c8-config` Features & Capabilities

An exhaustive overview covering **100% of the features, rules, and capabilities** provided by `@sebastienrousseau/c8-config`.
...
| :--- | :--- | :--- | :--- |
| **All Files Inspection** | Core | Active | Enforces coverage across untouched source files (`all: true`) |
| **Branch Threshold** | Core | Active | Demands 100% branch test coverage (`branches: 100`) |
| **Function Threshold** | Core | Active | Demands 100% function test coverage (`functions: 100`) |
| **Line Threshold** | Core | Active | Demands 100% line test coverage (`lines: 100`) |
| **Statement Threshold** | Core | Active | Demands 100% statement test coverage (`statements: 100`) |
| **Multi-Format Reporting** | Core | Active | Emits text, lcov, and html reports simultaneously |
