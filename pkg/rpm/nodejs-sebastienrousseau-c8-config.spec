...
%global npm_bare      c8-config
%global sitelib       %{_prefix}/lib/node_modules

Name:           nodejs-sebastienrousseau-c8-config
Version:        0.0.7
Release:        1%{?dist}
Summary:        Shareable c8 code coverage configuration files and rules

License:        Apache-2.0 OR MIT
URL:            https://github.com/sebastienrousseau/c8-config
Source0:        %{name}-%{version}.tar.gz
BuildArch:      noarch
Requires:       nodejs >= 20

%description
@sebastienrousseau/c8-config is a shareable configuration preset with no runtime
