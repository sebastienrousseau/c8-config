...
screenshot_alt: "@sebastienrousseau/c8-config architecture and rule enforcement."
footer_note: "@sebastienrousseau/c8-config is part of the @sebastienrousseau/config suite. Published under Apache-2.0 OR MIT."
copyright: "© 2026 Sebastien Rousseau. Licensed under Apache-2.0 OR MIT."
translation_key: "home"
title: "@sebastienrousseau/c8-config — Shareable c8 configuration rules for native V8 code coverage reporting."
description: "Shareable c8 configuration rules for native V8 code coverage reporting."
keywords: "c8-config, c8, v8 coverage, code coverage, test reporting, istanbul, javascript, developer tools, sebastien rousseau, standard"
hero_tag: "v0.0.4"
hero_tagline: "Native V8 code coverage and strict test reporting configuration"
headline: "@sebastienrousseau/c8-config"
lead: "Shareable c8 configuration rules for native V8 code coverage reporting."
cta_primary: "Install @sebastienrousseau/c8-config"
...
snippet_caption: "Install @sebastienrousseau/c8-config"
snippet_code: "npm install --save-dev @sebastienrousseau/c8-config"
...
**@sebastienrousseau/c8-config** is an enterprise-grade, shareable configuration for [c8](https://github.com/sebastienrousseau/c8-config)—the zero-instrumentation native V8 code coverage tool for Node.js. Designed to deliver vetted, deterministic defaults, this package eliminates manual setup boilerplate and establishes rigorous code quality standards across modern software development pipelines.
...
```json
{
  "extends": "@sebastienrousseau/c8-config"
}
```
...
Yes. Every configuration allows local overrides directly within your `.c8rc.json` file or inline settings. Detailed override recipes are documented in the [Usage Guide](usage/).
